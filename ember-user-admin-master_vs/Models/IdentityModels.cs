...
namespace Web.Models
{
    ...
    public class ApplicationUser : IdentityUser
    {
        ...
        public static dynamic GetSummarySet(string id=null, int limit = 500, string searchBy = ""){
          ...
          foreach (var role in thingy)
            ...
            var usersList = string.IsNullOrEmpty(searchBy) ? userManager.Users.Include("Notes").Include("Logs").ToList() : userManager.Users.Include("Notes").Include("Logs").Where(x => x.Email.Contains(searchBy) == true || x.First.Contains(searchBy) == true || x.Last.Contains(searchBy) == true).ToList();
